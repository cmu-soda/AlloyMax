...
run {
	...
	maxsome rs: set Role | all r: rs | Assign -> IntGrade in r.rule
}
  ==================================================
    kodkod formula:
  ==================================================
  ...
  ==================================================
*/
public final class GradeSysTest3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Formula x37=x38.not();
        Variable x43=Variable.unary("rs");
        Decls x42=x43.setOf(x27);
        Variable x46=Variable.unary("r");
        Decls x45=x46.oneOf(x43);
        Expression x48=x9.product(x11);
        ...
        Formula x60=x10.eq(x10);
        Formula x61=x11.eq(x11);
        Formula x62=x12.eq(x12);
        Formula x63=x13.eq(x13);
        Formula x14=Formula.compose(FormulaOperator.AND, x15, x17, x20, x22, x24, x33, x37, x41, x50, x51, x52, x53, x54, x55, x56, x57, x58, x59, x60, x61, x62, x63);
