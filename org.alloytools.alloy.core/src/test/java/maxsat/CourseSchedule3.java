...
run {
	all s: Student | MustTakeCores[s] and maxsome courses.time
}
  ...
  ==================================================
    ...
    (all s: this/Alice + this/Bob | 
      ...
      maxsome (this/Student.courses . this/Course.time)) && 
    Int/min = Int/min && 
    Int/zero = Int/zero && 
    Int/max = Int/max && 
    Int/next = Int/next && 
...
public final class CourseSchedule3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Variable x69 = Variable.unary("s");
        Decls x68 = x69.oneOf(x29);
        Expression x72 = x69.join(x13);
        Expression x73 = x69.join(x14);
        Formula x71 = x72.in(x73);
        Expression x75 = x14.join(x15);
        Formula x74 = x75.maxSome();
        Formula x70 = x71.and(x74);
        ...
        Formula x16 = Formula.compose(FormulaOperator.AND, x17, x19, x21, x24, x26, x33, x36, x41, x43, x51, x53, x59, x67, x76, x77, x78, x79, x80, x81, x82, x83, x84, x85, x86, x87, x88, x89, x90, x91);
